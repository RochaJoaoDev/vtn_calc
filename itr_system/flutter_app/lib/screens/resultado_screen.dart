...
class ResultadoScreen extends StatelessWidget {
  ...
  double get _areaTrib =>
      (resultado['area_tributavel'] as num?)?.toDouble() ?? 0;
  ...
  Widget _headerCard() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            model.nomeProprietario.isNotEmpty
                ? model.nomeProprietario
                : 'Proprietário',
      ...
      Column(
        children: [
          ...
          _linha(
            ...
            '${_decimal.format(model.areaPreservacaoPermanente)} ha',
          ),
          _linha(
            'Reserva Legal',
            '${_decimal.format(model.areaReservaLegal)} ha',
          ),
          _linha(
            'Área Imprestável',
            '${_decimal.format(model.areaImprestavel)} ha',
          ),
          ...
          _linha(
            'Culturas e Lavouras',
            '${_decimal.format(model.areaCulturas)} ha',
          ),
          _linha('Pastagens', '${_decimal.format(model.areaPasagens)} ha'),
          _linha(
            'Florestas Cultivadas',
            '${_decimal.format(model.areaFlorestasCultivadas)} ha',
          ),
        ],
      ),
    );
    ...
    return _card(
      ...
      Column(
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: _situacaoColor.withOpacity(0.1),
                  borderRadius: BorderRadius.circular(20),
                  border: Border.all(color: _situacaoColor.withOpacity(0.3)),
                ),
                child: Text(
                  _situacao,
                  style: TextStyle(
          ...
          if (avisos.isNotEmpty) ...[const SizedBox(height: 14), ...avisos],
        ],
      ),
    );
  }
